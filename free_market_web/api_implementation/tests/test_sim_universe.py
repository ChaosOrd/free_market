...
from api_implementation.simulator_api import SimUniverse
...
class TestSimUniverse(TestCase):
    ...
    def setUp(self):
        ...
        self.pop1 = Mock()
        self.pop2 = Mock()
        self.population_cls.objects.filter.return_value = [self.pop1, self.pop2]

        self.universe_mock = Mock()
        self.sim_population_patcher = patch('api_implementation.simulator_api.SimPopulation')
    ...
    def test_from_universe_retreives_universe_populations(self):
        ...
        self.population_cls.objects.filter.assert_called_once_with(
